    ...
    <section id="contact" className="py-16 lg:py-24">
      <div className="max-w-2xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <a href={`mailto:${portfolio.email}`} className="inline-flex items-center gap-3 text-text-secondary hover:text-cyan transition-colors group">
            <Mail size={20} className="group-hover:scale-110 transition-transform" />
            <span className="font-body text-base">{portfolio.email}</span>
          </a>
          ...
          {portfolio.phone && (
            <a href={`tel:${portfolio.phone}`} className="inline-flex items-center gap-3 text-text-secondary hover:text-cyan transition-colors group">
              ...
              <span className="font-body text-base">{portfolio.phone}</span>
            </a>
          )}
        </div>
      </div>
